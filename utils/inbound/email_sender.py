...
from utils.inbound.calendar_utils import InboundCalendarGenerator
from utils.config import INBOUND_EMAIL_CONFIG
...
class InboundEmailSender:
    ...
    def __init__(self, smtp_host: str = None, smtp_port: int = None):
        ...
        self.sender_email = INBOUND_EMAIL_CONFIG["sender"] or os.getenv("EMAIL_SENDER", "inbound@prostech.vn")
        self.sender_password = INBOUND_EMAIL_CONFIG["password"] or os.getenv("EMAIL_PASSWORD", "")
